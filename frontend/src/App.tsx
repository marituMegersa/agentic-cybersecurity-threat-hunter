...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Cybersecurity Incident Response & Threat Hunter</h1>
      <p style={{ color: '#666' }}>Autonomous SOC threat detection, log anomaly analysis, MITRE ATT&CK mapping, and automated incident response.</p>
